...
export excel using "GSS08.xls", firstrow(variables)

import excel "GSS08.xls", firstrow clear
...
describe // observation and variable numbers appear at the top of the output
count // also provides observation numbers

/* 1. Variables: 125 */
/* 2. Observations: 2,023 */
...
gen bachelors = (DEGREE == 3) // another way to make binary variables
drop if AGE == 36
...
rename babies inhouse_babies
rename preteen inhouse_preteen
rename team inhouse_team
rename adults inhouse_adults

label var bachelors "Indicator for a Bachelors Degree"
label define bach 0 "No Bachelors" 1 "Bachelors"
label values bachelors bach
...
// Many options for different types of graphs - here are a few examples
